...
public class ActionResource {
  ...
  public Response invokeAction(
    ...
    try {
      ...
      WorkItemLifecycleEventPublisherUtil.publish( "?", params, WorkItemLifecyclePhase.FAILED, e.toString() );
      return Response.status( HttpStatus.SC_BAD_REQUEST ).build();
    }

    final String workItemUid = ActionUtil.extractUid( params );
    WorkItemLifecycleEventPublisherUtil.publish( workItemUid, params, WorkItemLifecyclePhase.RECEIVED );
